...
function fetch
{
	...
	curl$timestring -s -R --retry 1 -o $name https://ftp.ncbi.nih.gov/pub/taxonomy/$prefix/$name
	return=$?
	...
	then
		...
		curl -s -R --retry 1 -o $name.md5 https://ftp.ncbi.nih.gov/pub/taxonomy/$prefix/$name.md5
